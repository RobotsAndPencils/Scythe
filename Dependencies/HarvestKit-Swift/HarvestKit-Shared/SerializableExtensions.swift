...
public extension Timer {
    ...
    */
    var serialisedObject: [String: Any] {
        ...
        if !externalReference.isEmpty {
            mutableDictionary["external_ref"] = externalReference
        }

        if let spentAt = spentAt {
            mutableDictionary["spent_at"] = Timer.dateOnlyFormatter.string(from: spentAt)
        }
...
public extension Contact {
    ...
    */
    var serialisedObject: [String: Any] {
        ...
        var mutableContactContainer = [String: Any]()
...
public extension Client {
    ...
    var serialisedObject: [String: Any] {
        ...
        var mutableClientContainer = [String: Any]()
