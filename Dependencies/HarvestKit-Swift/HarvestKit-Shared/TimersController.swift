...
public final class TimersController {
    ...
    */
    public func getTimers(_ user: User?, date: Date?, completionHandler: @escaping (_ timers: ([Timer], [Project])?, _ requestError: Error?) -> ()) {
        ...
        requestController.get(path) { (response: TSCRequestResponse?, requestError: Error?) -> Void in
            ...
            if let timerResponseDictionary = response?.dictionary as? [String: AnyObject],
               let timerEntriesArray = timerResponseDictionary["day_entries"] as? [[String: AnyObject]],
               let projectsJSONArray = timerResponseDictionary["projects"] as? [[String: AnyObject]] {
                
                let timersArray = timerEntriesArray.flatMap(Timer.init)
                let projectsArray = projectsJSONArray.flatMap(Project.init)
                
                completionHandler((timersArray, projectsArray), nil)
                return
            }
    ...
    /**
     ...
     - parameter completionHandler: The completion handler to return timers and errors to
     */
    public func getTimers(_ user: User?, completionHandler: @escaping (_ timers: ([Timer], [Project])?, _ requestError: Error?) -> ()) {
    ...
    /**
     ...
     - parameter completionHandler: The completion handler to return timers and errors to
     */
    public func getTimers(_ date: Date?, completionHandler: @escaping (_ timers: ([Timer], [Project])?, _ requestError: Error?) -> ()) {
    ...
    /**
     ...
     - parameter completionHandler: The completion handler to return timers and errors to
     */
    public func getTimers(_ completionHandler: @escaping (_ timers: ([Timer], [Project])?, _ requestError: Error?) -> ()) {
